...
{{-- for search/start --}}
      ...
      <input type="hidden" id="ajax_url_get_account_balance" value="{{route('admin.exchange_transaction.get_account_balance')}}">
      {{-- for search/end --}}
            ...
            <div class="row">
             ...
             <div class="col-md-12">
                <div class="form-group text-center">
                    <button type="submit" id="do_exchange_now_btn" class="btn btn-warning btn-sm">Exchange Now</button>
                </div>
             </div>
