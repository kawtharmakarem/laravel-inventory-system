        ...
        <div class="col-md-6">
         <div class="form-group">
          <label for="name">Financial account name</label>
                <input type="text" id="name" name="name" class="form-control" value="{{old('name')}}" placeholder="Enter account Name"/>
                 @error('name')
          ...
          <div class="form-group">
              <label for="is_parent">Is_parent_account</label>
                <select class="form-control" name="is_parent" id="is_parent">
                        <option value="">Select..</option>
                        <option  @if(old('is_parent')==1) selected='selected' @endif value="1">yes</option>
                        <option @if(old('is_parent')==0 and old('is_parent')!='') selected='selected' @endif value="0">no</option>
                    </select>
                     @error('is_parent')
                       <span class="text-danger">{{$message}}</span>  
                     @enderror
